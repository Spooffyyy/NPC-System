...
class CustomNPC extends Human implements ChunkLoader
{
	...
	public static function saveNBT(Vector3 $pos, ?Vector3 $motion = null, float $yaw = 0.0, float $pitch = 0.0): CompoundTag
	{
		return parent::saveNBT($pos, $motion, $yaw, $pitch); // TODO: Change the autogenerated stub
	}
